...
public class StudentChangeInfo extends JFrame implements ActionListener
{
	...
	public StudentChangeInfo(String userId,String name)
	{
	...
	{	
		...
		if(a.getSource()==submit)
		{
			...
			try
			{
				...
				query = "UPDATE `student` SET `name`="+'"'+name+'"'+" where id="+'"'+this.userId+'"';
